import { q as jsxRuntimeExports, c as reactExports, R as React, p as React$1 } from "./worker-entry-yMGtmKpA.js";
import { L as Link, r as reactDomExports, R as ReactDOM, u as useNavigate, t as toast } from "./router-DljChdAV.js";
import { X, u as useAuth, g as getHabits, M as MessagesSquare, P as Plus, B as BottomNav, A as AddHabitSheet } from "./use-auth-SxBD0S2x.js";
import { t as timeAgo, M as MessageCircle, C as CATEGORIES, i as inferUserCategories, p as pickDefaultCategory, f as fetchQuestions, a as postQuestion } from "./community-CYxHFAiL.js";
import { c as composeRefs, u as useComposedRefs, a as cva, T as Textarea, B as Button } from "./button-CVSNb5_N.js";
import { _ as __assign, a as __rest, b as __spreadArray } from "./tslib.es6-CB2axT3X.js";
import { c as cn } from "./utils-Bz4m9VPB.js";
import { C as ChevronDown } from "./chevron-down-BL2qIlGP.js";
import { C as Check } from "./check-BeYyW1NL.js";
import { c as createLucideIcon } from "./createLucideIcon-BDWwxIey.js";
import { f as fetchHabitsFromCloud } from "./habits-cloud-BEKJqQAE.js";
import { S as Sparkles } from "./sparkles-C1VBMXel.js";
import "node:events";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground leading-snug", children: question.body }),
...
function AskQuestionSheet({ open, onClose, onSubmit, defaultCategory }) {
  const [body, setBody] = reactExports.useState("");
  const [category, setCategory] = reactExports.useState(defaultCategory);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "bottom", className: "rounded-t-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { children: "Ask the community" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 mt-4 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5 block", children: "Category" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5 block", children: "Your question" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            value: body,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-[11px] text-muted-foreground mt-1", children: [
          body.length,
          "/280"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Posts are anonymous — no usernames are shown to anyone." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          className: "w-full",
          children: submitting ? "Posting…" : "Post anonymously"
        }
      )
    ] })
  ] }) });
...
function QuestionsPage() {
  ...
  const [askOpen, setAskOpen] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    (async () => {
      if (user) {
        try {
          setHabits(await fetchHabitsFromCloud(user.id));
        } catch {
          setHabits(getHabits());
        }
      } else {
  ...
  const myCategories = reactExports.useMemo(() => inferUserCategories(habits), [habits]);
  const defaultCategory = reactExports.useMemo(() => pickDefaultCategory(habits), [habits]);
  const refresh = reactExports.useCallback(async () => {
    if (!user) return;
    setLoading(true);
    try {
      const filterCats = activeCat ? [activeCat] : tab === "for-you" && myCategories.length > 0 ? myCategories : void 0;
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      if (cancelled) return;
      const channel = supabase.channel("community-questions").on("postgres_changes", {
        event: "*",
        schema: "public",
  ...
  const handlePost = async (category, body) => {
    if (!user) return;
    try {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto px-5 pt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessagesSquare, { className: "w-5 h-5 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold tracking-tight", children: "Questions" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: () => setAskOpen(true), className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4" }),
          " Ask"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 mb-4 p-1 rounded-xl bg-muted/50 w-fit", children: [{
        id: "for-you",
        label: "For you"
      }, {
        id: "all",
        ...
        id: "mine",
        label: "Mine"
      }].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        setTab(t.id);
        setActiveCat(null);
      }, className: `px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${tab === t.id ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`, children: t.label }, t.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveCat(null), className: `px-2.5 py-1 rounded-full text-[11px] uppercase tracking-wider font-semibold transition-colors ${activeCat === null ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:text-foreground"}`, children: "All" }),
        CATEGORIES.map((c) => {
          const isMine = myCategories.includes(c);
          return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveCat(activeCat === c ? null : c), className: `px-2.5 py-1 rounded-full text-[11px] uppercase tracking-wider font-semibold transition-colors ${activeCat === c ? "bg-primary text-primary-foreground" : isMine ? "bg-primary/10 text-primary hover:bg-primary/15" : "bg-muted text-muted-foreground hover:text-foreground"}`, children: c }, c);
        })
      ] }),
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-sm text-muted-foreground py-12", children: "Loading…" }) : questions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-dashed border-border/60 py-12 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-6 h-6 text-muted-foreground/40 mx-auto mb-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-medium", children: "No questions yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 mb-4", children: tab === "mine" ? "You haven't posted anything yet." : "Be the first to ask." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => setAskOpen(true), children: "Ask a question" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: questions.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx(QuestionCard, { question: q }, q.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AskQuestionSheet, { open: askOpen, onClose: () => setAskOpen(false), onSubmit: handlePost, defaultCategory }),

...
function getSparkForDate(dateKey) {
...
const VISITED_KEY = "dailymint_spark_visited";
...
function saveAnswer(date, question, answer) {
...
function getAnswerForDate(date) {
...
function markSparkVisited(date) {

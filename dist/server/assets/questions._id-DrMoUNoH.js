...
import { a as Route, u as useNavigate, t as toast, L as Link } from "./router-DljChdAV.js";
...
import { b as fetchQuestion, c as fetchReplies, t as timeAgo, M as MessageCircle, d as deleteQuestion, r as reportPost, e as postReply, g as deleteReply } from "./community-CYxHFAiL.js";
...
function QuestionDetailPage() {
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      if (cancelled) return;
      const channel = supabase.channel(`question:${id}`).on("postgres_changes", {
        event: "*",
        schema: "public",

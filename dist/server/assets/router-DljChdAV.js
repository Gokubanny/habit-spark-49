...
const appCss = "/assets/styles-28l9cS5N.css";
...
const $$splitComponentImporter$7 = () => import("./spark-DMzsMXr9.js");
const Route$7 = createFileRoute("/spark")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A daily quote, question, or insight to spark reflection and momentum."
    }]
  })
});
const $$splitComponentImporter$6 = () => import("./settings-DuNTDYFm.js");
const Route$6 = createFileRoute("/settings")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Customize your Emberly experience."
    }]
  })
});
const $$splitComponentImporter$5 = () => import("./questions-KXgvip8d.js");
const Route$5 = createFileRoute("/questions")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Anonymous questions and reflections from people building habits like yours."
    }]
  })
});
const $$splitComponentImporter$4 = () => import("./login-CgOJbegh.js");
const Route$4 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./insights-ZtL7THWo.js");
const Route$3 = createFileRoute("/insights")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component"),
  head: () => ({
    meta: [{
      title: "Emberly — Insights"
    }, {
      name: "description",
...
const $$splitComponentImporter$2 = () => import("./app-BvnT4FWm.js");
const Route$2 = createFileRoute("/app")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Build lasting habits with Emberly. Simple streak tracking, beautiful progress visualization."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./index-DJigG-L5.js");
...
const $$splitComponentImporter = () => import("./questions._id-DrMoUNoH.js");
const Route2 = createFileRoute("/questions/$id")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Anonymous reflections from the community."
    }]
  })
});
const SparkRoute = Route$7.update({
  id: "/spark",
  path: "/spark",
...
const QuestionsRoute = Route$5.update({
  id: "/questions",
  path: "/questions",
  getParentRoute: () => Route$8
});
...
const QuestionsIdRoute = Route2.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => QuestionsRoute
});
const QuestionsRouteChildren = {
  QuestionsIdRoute
};

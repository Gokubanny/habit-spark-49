import { c as reactExports, p as React, q as jsxRuntimeExports } from "./worker-entry-yMGtmKpA.js";
import { r as reactDomExports, L as Link, u as useNavigate, t as toast } from "./router-DljChdAV.js";
import { i as isCompletedToday, f as getStreak, h as frequencyLabel, H as HABIT_COLORS, X, F as FrequencyPicker, j as createHabit, u as useAuth, k as isScheduledToday, s as saveHabits, B as BottomNav, A as AddHabitSheet, g as getHabits, a as getLogs, t as todayKey, l as toggleHabit, b as saveLogs, m as updateHabit, n as getMilestoneMessage } from "./use-auth-SxBD0S2x.js";
import { C as Check } from "./check-BeYyW1NL.js";
import { B as Bell, S as Sparkles } from "./sparkles-C1VBMXel.js";
import { T as Trash2 } from "./trash-2-CWR6Tq_E.js";
import { L as Leaf, u as useProfile, U as UserAvatar, a as rescheduleAllReminders, s as scheduleReminder } from "./UserAvatar-CoNHAhap.js";
import { A as ArrowRight } from "./arrow-right-Dm2SxIIC.js";
import { isBannerDismissedToday, getSparkForDate, todayDateKey, dismissBannerToday } from "./spark-CNtxnI4v.js";
import { r as reorderHabitsInCloud, m as migrateLocalToCloud, f as fetchHabitsFromCloud, a as fetchLogsFromCloud, d as deleteHabitFromCloud, t as toggleLogInCloud, s as saveHabitToCloud, u as updateHabitInCloud } from "./habits-cloud-BEKJqQAE.js";
...
function OnboardingFlow({ onComplete }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-sm w-full", children: [
    ...
    step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center animate-fade-up-blur", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-foreground tracking-tight", style: { lineHeight: "1.2" }, children: "Welcome to Emberly" }),
...
function HomeSparkBanner() {
  const [visible, setVisible] = reactExports.useState(false);
  const [spark, setSpark] = reactExports.useState(null);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-4 rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-card to-card p-4 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/spark", className: "block pr-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[11px] uppercase tracking-wider text-primary font-semibold mb-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3" }),
        label
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/90 leading-snug line-clamp-2", children: spark.text }),
      spark.attribution && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
        "— ",
        spark.attribution
      ] })
    ] })
...
function TodayPage() {
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      const channel = supabase.channel(`app:${user.id}`).on("postgres_changes", {
        event: "*",
        schema: "public",
        table: "habits",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pb-28 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-lg mx-auto px-5 pt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between animate-fade-up-blur", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-shrink-0 -mt-1", children: [
          scheduledToday.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressRing, { completed: completedCount, total: scheduledToday.length }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/settings", "aria-label": "Open settings", className: "rounded-full transition active:scale-95 hover:opacity-80", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { url: profile?.avatar_url, email: user?.email, name: profile?.display_name, size: 40 }) })
        ] })
      ] }),
      habits.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(HomeSparkBanner, {}),

...
function useProfile(userId) {
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      const { supabase } = await import("./client-DZSvFFWO.js");
      if (cancelled) return;
      const channel = supabase.channel(`profile:${userId}`).on(
        "postgres_changes",
...
function UserAvatar({ url, email, name, size = 36, className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: showImage ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        !loaded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-pulse bg-muted", "aria-hidden": true }),
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold tracking-tight", children: initials(name, email) })
    }
  );
}
export {
